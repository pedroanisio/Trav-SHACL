...
class RangeMinInclusiveConstraint(Constraint):
    """Represents sh:minInclusive constraints."""

    SOURCE_COMPONENT = "http://www.w3.org/ns/shacl#MinInclusiveConstraintComponent"
