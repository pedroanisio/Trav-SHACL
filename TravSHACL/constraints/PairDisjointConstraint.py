...
class PairDisjointConstraint(Constraint):
    """Represents sh:disjoint constraints."""

    SOURCE_COMPONENT = "http://www.w3.org/ns/shacl#DisjointConstraintComponent"
    ...
    def emit_filter(self, builder, focus_var, or_value: int = 0, or_affix: int = 0, maxonly: bool = False):
        ...
        builder.add_triple(self.referenced_property_sparql(), "?" + value_var)
