...
class RangeMaxExclusiveConstraint(Constraint):
    """Represents sh:maxExclusive constraints."""

    SOURCE_COMPONENT = "http://www.w3.org/ns/shacl#MaxExclusiveConstraintComponent"
